...
export class ProfileComponent {
  ...
  protected readonly role = computed(() => this.user()?.role ?? 'USER');
  ...
  protected saveProfile(): void {
    ...
    if (!this.user()) {
      this.profileError.set('Data akun tidak tersedia.');
    ...
    this.profileService
      ...
      .subscribe({
        next: (updatedUser) => {
          ...
          this.profileSuccess.set('Perubahan profil berhasil disimpan.');
          this.profileError.set(null);
  ...
  protected changePassword(): void {
    ...
    this.profileService
      ...
      .subscribe({
        next: () => {
          this.passwordSuccess.set('Password berhasil diganti.');
          this.passwordError.set(null);
  ...
  private resolveProfileError(error: HttpErrorResponse): string {
    ...
    return 'Gagal menyimpan perubahan profil. Silakan coba lagi.';
  }
